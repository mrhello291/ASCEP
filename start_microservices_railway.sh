...
# ASCEP Microservices Startup Script for Railway Production
# Starts all microservices in the proper order for Railway deployment

set -e

echo "🚀 Starting ASCEP Microservices on Railway..."
...
# Railway automatically provides REDIS_URL, REDIS_HOST, REDIS_PORT, REDIS_PASSWORD
# We don't need to start Redis locally as Railway provides it as a service
...
echo -e "${GREEN}"
echo "🎉 All ASCEP Microservices Started Successfully on Railway!"
echo "=========================================================="
...
echo ""
echo "🔗 Redis: Connected to Railway Redis service"
